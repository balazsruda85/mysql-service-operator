...
# mycompany.org/mysql-service-operator-bundle:$VERSION and mycompany.org/mysql-service-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= mycompany.org/mysql-service-operator
...
ifeq (,$(shell which ansible-operator 2>/dev/null))
	...
	curl -sSLo $(ANSIBLE_OPERATOR) https://github.com/operator-framework/ansible-operator-plugins/releases/download/v1.42.0/ansible-operator_$(OS)_$(ARCH) ;\
